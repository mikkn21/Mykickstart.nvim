...
nnoremap <Space>K <Cmd>call VSCodeNotify('editor.action.showHover')<CR>
...
xnoremap <Space>dH <Cmd>call VSCodeNotify('editor.action.showHover')<CR>
...
nnoremap <Space>ca <Cmd>call VSCodeNotify('editor.action.quickFix')<CR>
